...
func testSyncReplaceDirModTime(t *testing.T, copyEmptySrcDirs bool) {
	...
	file3 := r.WriteFile("test_dir1/file3", "file3", t2)
	file4 := r.WriteFile("test_dir2/file4", "file4", t2)
	file5 := r.WriteFile("test_dir2/file5", "file5", t2)
	file6 := r.WriteFile("test_dir3/file6", "file6", t2)
	file7 := r.WriteFile("file7", "file7", t2)
	file8 := r.WriteFile("test_dir3/sub_dir/file8", "file8", t2)
	r.CheckLocalItems(t, file1, file2, file3, file4, file5, file6, file7, file8)
	...
	// Save all dirs
	dirs := []string{"test_dir1", "test_dir2", "test_dir3", "test_dir3/sub_dir", "empty_on_remote"}
	if copyEmptySrcDirs {
	...
	testLoggerVsLsf(ctx, r.Fremote, operations.GetLoggerOpt(ctx).JSON, t)
	r.CheckLocalItems(t, file1, file2, file3, file4, file5, file6, file7, file8)
	r.CheckRemoteItems(t, file1, file2, file3, file4, file5, file6, file7, file8)
